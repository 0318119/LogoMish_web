...
function Header() {
  ...
  return (
    <>
      <section className={`${styles.headerSection}`} id={isMenu ? styles.setBg : false }>
            ...
            <div className="row">
              <div className="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-between p-3">
                ...
                <div className='px-3 d-flex align-items-center justify-content-between'>
                  ...
                  {isMenu && (
                    <span onClick={() => { setMenu(false) }}><MenuIcon className={styles.MenuIcon} /></span>
                  )}
                  <Bar className={styles.barIcon} onClick={handleMenu} />
                </div>
              </div>
            </div>
          </div>
